...
df = pd.read_csv('https://raw.github.com/Raufjatoi/Uni-first-proj/main/Data/cleanedmobiles.csv')
df = df[['Brand_10.or',
 ...
 'Brand_iBall', 'Brand_mPhone','Screen size (inches)', 'Resolution x','Price', 'Resolution y', 'Processor',
       'RAM (GB)', 'Internal storage (GB)', 'Rear camera', 'Front camera','Battery capacity (mAh)']].head(1339)
...
print(predict_mobiles('Infinix',5000,6.6 , 720, 1080 ,6.  , 2 ,32, 13 , 8))
