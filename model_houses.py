...
df = pd.read_csv('https://raw.github.com/Raufjatoi/Uni-first-proj/main/Data/Housing1.csv')
...
#model = GradientBoostingRegressor(max_features=0.8,alpha=0.1,loss='squared_error',n_estimators=255, learning_rate=0.1, random_state=42,criterion='friedman_mse')
model = SGDRegressor(loss='squared_error',penalty='l1',alpha=0.1,epsilon=0.1,eta0=0.001,max_iter=400,learning_rate='adaptive',random_state=42)
